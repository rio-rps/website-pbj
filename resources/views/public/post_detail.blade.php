...
<article class="post ttm-blog-single">
    <div class="ttm-post-featured-wrapper">
        <div class="ttm-post-featured">
            <img class="img-fluid thumbnailPost" src="{{ asset('images/thumbnail/' . $row->post_thumbnail) }}" alt="post-01">
        </div>
        <div class="ttm-post-featured">
            <div class="post-meta">
                <span class="ttm-meta-line entry-date"><i class="fa fa-calendar"></i><time class="entry-date published">{{cek_date_ddmmyyyy_his_v1($row->tgl_terbit)}}</time></span>
