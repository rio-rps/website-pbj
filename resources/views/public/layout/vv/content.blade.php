                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <fieldset class="form-group has-danger">
                                ...
                                <p class="text-right mt-1"><small class="danger text-muted">Use<code>.has-danger</code>
                                        class for
                                        danger state</small></p>
                            </fieldset>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <fieldset class="form-group has-success">
                                ...
                                <p class="text-right mt-1"><small class="success text-muted">Use<code>.has-success</code>
                                        class
                                        for success state</small></p>
                            </fieldset>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <fieldset class="form-group has-warning">
                                ...
                                <p class="text-right mt-1"><small class="warning text-muted">Use<code>.has-warning</code>
                                        class
                                        for warning state</small></p>
                            </fieldset>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" class="form-control form-control-lg mb-1" id="iconLeft2" placeholder="Icon Left, Large Input">
                                <div class="form-control-position">
                                    <i class="feather icon-unlock warning font-medium-4"></i>
                                </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <p>Large Input class <code>.form-control-lg</code>&amp; <code>.font-medium-4</code> class for
                                Large Icon </p>
                            <fieldset class="form-group position-relative">
                                <input type="text" class="form-control form-control-lg mb-1" id="iconLeft3" placeholder="Icon Right, Large Input">
                                <div class="form-control-position">
                                    <i class="feather icon-feather info font-medium-4"></i>
                                </div>
                                <small>Large Input class <code>.form-control-lg</code>&amp; <code>.font-medium-4</code>
                                    class for Large Icon </small>
                            </fieldset>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <fieldset class="form-group position-relative">
                                ...
                                <div class="form-control-position">
                                    <i class="feather icon-file warning"></i>
                                </div>
                            </fieldset>
                        </div>
                    </div>
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" class="form-control form-control-sm mb-1" id="iconLeft6" placeholder="Icon Left, Small Input">
                                <div class="form-control-position">
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <fieldset class="form-group position-relative">
                                <input type="text" class="form-control form-control-sm mb-1" id="iconLeft7" placeholder="Icon Right, Small Input">
                                <div class="form-control-position">
                                    <i class="feather icon-bell success font-small-4"></i>
                                </div>
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" class="form-control round mb-1" id="iconLeft10" placeholder="Icon Left, Default Input">
                                <div class="form-control-position">
                                    <i class="feather icon-user warning"></i>
                                </div>
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <fieldset class="form-group position-relative">
                                <input type="text" class="form-control round mb-1" id="iconLeft11" placeholder="Icon Right, Default Input">
                                <div class="form-control-position">
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" class="form-control mb-1" id="iconLeft12" placeholder="Icon Left, Default Input">
                                <div class="form-control-position">
                                    <i class="feather icon-loader spinner"></i>
                                </div>
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <fieldset class="form-group position-relative">
                                <input type="text" class="form-control mb-1" id="iconLeft13" placeholder="Icon Right, Default Input">
                                <div class="form-control-position">
                                    <i class="spinner feather icon-refresh-cw"></i>
                                </div>
