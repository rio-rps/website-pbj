 ...
 <div class="second-footer ttm-textcolor-white" style="background-color:#888888;">
     <div class="container">
         <div class="row">
             ...
             <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                 <div class="widget link-widget clearfix">
                     ...
                     <ul id="menu-footer-services">
                         <li><a target="blank" href="{{route('index')}}">Home</a></li>
                         <li><a href="{{route('page',['slug'=>'kontak'])}}">Kontak Kami</a></li>
             ...
             <div class=" col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                 <div class="widget widget_text clearfix">
                     <h3 class="widget-title">Situs Kelola</h3>
                     <div class="textwidget widget-text">
                         Dikelola Oleh Biro Pengadaan Barang/Jasa Provinsi Sumatera Selatan
                     </div>
                 </div>
             </div>
             <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
 ...
 <div class="bottom-footer-text ttm-bgcolor-darkgrey ttm-textcolor-white">
     <div class="container">
         <div class="row copyright">
             <div class="col-md-6">
                 <div class="">
                     <span>Copyright © 2023&nbsp;Biro Pengadaan Barang/Jasa</span>
                 </div>
             </div>
             <div class="col-md-6">
