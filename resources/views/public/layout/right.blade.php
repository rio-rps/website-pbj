 ...
 <div class="card mb-35">
     ...
     <ul class="widget-post ttm-recent-post-list mb-20">
         ...
         <li>
             <a href="{{route('postdetail',['slug'=>$dt->slug_title])}}"><img src="{{ asset('images/thumbnail/' . $dt->post_thumbnail) }}" alt="post-img"></a>
     ...
     <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
         <div class="carousel-inners">
             ...
             <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                 <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[{{$photo->id_galeri_photo_detail}}]" title="" data-rel="photoslide{{$photo->id_galeri_photo_detail}}" href="{{ asset('images/galeri_photo/' . $photo->gambar_galeri_photo) }}">
                     <img src="{{ asset('images/galeri_photo/' . $photo->gambar_galeri_photo) }}" alt="{{$photo->nm_galeri_photo}}" class="img-{{$photo->id_galeri_photo_detail}}">
                 </a>
             </div>
             @endforeach
         </div>
 ...
 <div class="card mb-35">
     ...
     <div id="video" class="carousel slide" data-ride="carousel">
         <div class="carousel-inners">
             ...
             <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                 <iframe style="height: 170px; width: 100%;" class="img-thumbnail" src=" https://www.youtube.com/embed/{{ getYoutubeVideoID($video->link_video) }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
             </div>
             @endforeach
         </div>
