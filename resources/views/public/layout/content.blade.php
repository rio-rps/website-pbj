									...
									<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
										<div class="carousel-inner">
											<div class="carousel-item active">
												<img class="d-block w-100" src="{{ asset('/') }}images/carousel/02.jpg" alt="First slide">
											</div>
											<div class="carousel-item">
												<img class="d-block w-100" src="{{ asset('/') }}images/carousel/03.jpg" alt="Second slide">
											</div>
											<div class="carousel-item">
												<img class="d-block w-100" src="{{ asset('/') }}images/carousel/04.jpg" alt="Third slide">
											</div>
										</div>
					...
					<div class="card mb-35">
						...
						<div class="ttm-pf-single-detail-box mb-35">
							...
							<ul class="ttm-pf-detailbox-list">
								<li><i class="fa fa-user"></i><span> Client : </span>John Amanda</li>
								<li><i class="fa fa-bookmark-o"></i><span> Category : </span>Business, Campaign</li>
								<li><i class="fa fa-calendar"></i><span> Date : </span>6 June 19</li>
								<li><i class="ti ti-world"></i><span> Website : </span>IT-Tech.com</li>
								<li><i class="fa fa-map-marker"></i><span>Location : </span>New York</li>
							</ul>
						</div>
						...
						<aside class="widget widget widget_media_gallery">
							...
							<div class="">
								<div class="gallery-item">
									<a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" data-rel="prettyPhoto" href="https://via.placeholder.com/1200x800/444444.jpg">
