<div class="modal fade" id="modalFormData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('photo.update',$id) }}" class="formData" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea name="nm_galeri_photo" class="form-control" cols="20" rows="3">{{$row->nm_galeri_photo}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="date" class="form-control" name="tgl_galeri_photo" value="{{$row->tgl_galeri_photo}}">
                            </div>
                        </div>
                    </div>
                </div>
