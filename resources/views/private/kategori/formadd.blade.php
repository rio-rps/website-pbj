<div class="modal fade" id="modalFormData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('kategori.store') }}" class="formData" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="nm_kategori" maxlength="50">
                            </div>
                        </div>
                    </div>
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea name="ket_kategori" class="form-control" cols="20" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
