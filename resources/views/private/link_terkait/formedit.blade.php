<div class="modal fade" id="modalFormData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('linkterkait.update',$id) }}" class="formData" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="nm_situs" value="{{$row->nm_situs}}" maxlength="50">
                            </div>
                        </div>
                    </div>
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="url" name="link_situs" value="{{$row->link_situs}}" placeholder="http://">
                            </div>
                        </div>
                    </div>
                </div>
