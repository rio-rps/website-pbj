<div class="modal fade" id="modalFormData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('photodetail.store') }}" class="formDataMultipart" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id_galeri_photo" value="{{$id_galeri_photo}}">
                <div class="modal-body">
                    <div class="form-body">
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label border-bottom">Upload Photo</label>
                            <div class="col-md-8">
                                <input type="file" class="form-control" name="gambar_galeri_photo" id="gambar_galeri_photo" accept="image/*">
                            </div>
                        </div>
                    </div>
