...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('/') }}private/images/logo/logo_prov.png">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('/') }}private/images/logo/logo_prov.png">
