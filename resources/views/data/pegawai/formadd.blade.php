<div class="modal fade" id="modalView" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('pegawai.store') }}" class="formSimpan" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="nip_pegawai" maxlength="18">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 label-control" for="projectinput1">Nama</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="nm_pegawai" maxlength="50">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn-send btn btn-primary btn-glow" id="tombolSimpan">
